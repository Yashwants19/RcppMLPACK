...
{
  return std::move((Rcpp::XPtr<LogisticRegression<>>) CLI::GetParam<LogisticRegression<>*>(paramName));
}
...
{
  CLI::GetParam<LogisticRegression<>*>(paramName) =  Rcpp::as<Rcpp::XPtr<LogisticRegression<>>>(ptr);
