 ...
 * called by the R linear_svm binding.
 */
...
{
  return std::move((Rcpp::XPtr<LinearSVMModel>) CLI::GetParam<LinearSVMModel*>(paramName));
}
...
{
  CLI::GetParam<LinearSVMModel*>(paramName) =  Rcpp::as<Rcpp::XPtr<LinearSVMModel>>(ptr);
