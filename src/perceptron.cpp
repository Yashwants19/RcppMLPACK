 ...
 * called by the R perceptron binding.
 */
...
{
  return std::move((Rcpp::XPtr<PerceptronModel>) CLI::GetParam<PerceptronModel*>(paramName));
}
...
{
  CLI::GetParam<PerceptronModel*>(paramName) =  Rcpp::as<Rcpp::XPtr<PerceptronModel>>(ptr);
