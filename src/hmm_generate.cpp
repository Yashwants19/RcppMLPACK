 ...
 * called by the R hmm_generate binding.
 */
...
{
  return std::move((Rcpp::XPtr<HMMModel>) CLI::GetParam<HMMModel*>(paramName));
}
...
{
  CLI::GetParam<HMMModel*>(paramName) =  Rcpp::as<Rcpp::XPtr<HMMModel>>(ptr);
