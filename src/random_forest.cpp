...
{
  return std::move((Rcpp::XPtr<RandomForestModel>) CLI::GetParam<RandomForestModel*>(paramName));
}
...
{
  CLI::GetParam<RandomForestModel*>(paramName) =  Rcpp::as<Rcpp::XPtr<RandomForestModel>>(ptr);
