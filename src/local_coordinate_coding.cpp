...
{
  return std::move((Rcpp::XPtr<LocalCoordinateCoding>) CLI::GetParam<LocalCoordinateCoding*>(paramName));
}
...
{
  CLI::GetParam<LocalCoordinateCoding*>(paramName) =  Rcpp::as<Rcpp::XPtr<LocalCoordinateCoding>>(ptr);
