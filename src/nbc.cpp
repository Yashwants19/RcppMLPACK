...
{
  return std::move((Rcpp::XPtr<NBCModel>) CLI::GetParam<NBCModel*>(paramName));
}
...
{
  CLI::GetParam<NBCModel*>(paramName) =  Rcpp::as<Rcpp::XPtr<NBCModel>>(ptr);
