...
{
  return std::move((Rcpp::XPtr<SoftmaxRegression>) CLI::GetParam<SoftmaxRegression*>(paramName));
}
...
{
  CLI::GetParam<SoftmaxRegression*>(paramName) =  Rcpp::as<Rcpp::XPtr<SoftmaxRegression>>(ptr);
