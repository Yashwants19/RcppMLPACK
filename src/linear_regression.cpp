 ...
 * called by the R linear_regression binding.
 */
...
{
  return std::move((Rcpp::XPtr<LinearRegression>) CLI::GetParam<LinearRegression*>(paramName));
}
...
{
  CLI::GetParam<LinearRegression*>(paramName) =  Rcpp::as<Rcpp::XPtr<LinearRegression>>(ptr);
