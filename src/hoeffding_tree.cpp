 ...
 * called by the R hoeffding_tree binding.
 */
...
{
  return std::move((Rcpp::XPtr<HoeffdingTreeModel>) CLI::GetParam<HoeffdingTreeModel*>(paramName));
}
...
{
  CLI::GetParam<HoeffdingTreeModel*>(paramName) =  Rcpp::as<Rcpp::XPtr<HoeffdingTreeModel>>(ptr);
