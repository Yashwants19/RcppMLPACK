...
{
  return std::move((Rcpp::XPtr<KFNModel>) CLI::GetParam<KFNModel*>(paramName));
}
...
{
  CLI::GetParam<KFNModel*>(paramName) =  Rcpp::as<Rcpp::XPtr<KFNModel>>(ptr);
