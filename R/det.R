...
#'   (0 is LOOCV)  Default value "10".
#' @param input_model Trained density estimation tree to load.
...
#'   tree only.  Default value "FALSE".
#' @param test A set of test points to estimate the density of.
