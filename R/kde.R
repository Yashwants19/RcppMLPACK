...
#'    Default value "dual-tree".
#' @param bandwidth Bandwidth of the kernel.  Default value "1".
#' @param initial_sample_size Initial sample size for Monte Carlo estimations. 
#'   Default value "100".
#' @param input_model Contains pre-trained KDE model.
...
#'   for Monte Carlo estimations.  Default value "3".
#' @param mc_probability Probability of the estimation being bounded by relative
#'   error when using Monte Carlo estimations.  Default value "0.95".
#' @param monte_carlo Whether to use Monte Carlo estimations when possible.  Default
#'   value "FALSE".
#' @param query Query dataset to KDE on.
#' @param reference Input reference dataset use for KDE.
...
#'   'octree', 'r-tree').  Default value "kd-tree".
...
#' \item{predictions}{Vector to store density predictions.}
#'
#' @details
