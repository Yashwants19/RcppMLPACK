...
#'   value "FALSE".
#' @param input_model Trained CF model to load.
...
#' @param normalization Normalization performed on the ratings.  Default value
#'   "none".
...
#' @param test Test set to calculate RMSE on.
#' @param training Input dataset to perform CF on.
