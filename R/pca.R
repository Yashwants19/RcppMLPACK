...
#'   dimensionality reduction is performed.  Default value "0".
#' @param scale If set, the data will be scaled before running PCA, such that the
#'   variance of each feature is 1.  Default value "FALSE".
#' @param var_to_retain Amount of variance to retain; should be between 0 and 1.  If
#'   1, all variance is retained.  Overrides -d.  Default value "0".
