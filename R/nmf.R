...
#'
#' @param input Input dataset to perform NMF on.
#' @param rank Rank of the factorization.
#' @param initial_h Initial H matrix.
#' @param initial_w Initial W matrix.
#' @param max_iterations Number of iterations before NMF terminates (0 runs until
#'   convergence.  Default value "10000".
...
#' \item{h}{Matrix to save the calculated H to.}
#' \item{w}{Matrix to save the calculated W to.}
#'
#' @details
