...
#'   reduces to linear regression.  Default value "0".
#' @param test Matrix containing X' (test regressors).
#' @param training Matrix containing training set X (regressors).
#' @param training_responses Optional vector containing y (responses). If not given,
#'   the responses are assumed to be the last row of the input file.
#' @param verbose Display informational messages and the full list of parameters and
#'   timers at the end of execution.  Default value "FALSE".
#'
#' @return A list with several components:
#' \item{output_model}{Output LinearRegression model.}
