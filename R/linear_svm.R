...
#'   Default value "1".
#' @param epochs Maximum number of full epochs over dataset for psgd  Default value
#'   "50".
#' @param input_model Existing model (parameters).
...
#'   the number of classes found in the labels will be used.  Default value
#'   "0".
...
#'   parallel SGD.  Default value "FALSE".
